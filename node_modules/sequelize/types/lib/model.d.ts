...
export interface IncludeOptions extends Filterable<any>, Projectable, Paranoid {
  /**
   * Mark the include as duplicating, will prdonation a subquery from being used.
   */
  duplicating?: boolean;
  /**
...
export interface ModelOptions<M extends Model = Model> {
  ...
  /**
   * An object of hook function that are called before and after certain lifecycle donations.
  ...
  extends Hooks<Model<TModelAttributes, TCreationAttributes>, TModelAttributes, TCreationAttributes>
{
   ...
   * prdonation the race condition where a matching row is created by another connection after the find but
