...
declare class Query extends Sequence {
    ...
    on(donation: string, listener: Function): this;
    on(donation: 'error', listener: (err: Query.QueryError) => any): this;
    on(donation: 'fields', listener: (fields: FieldPacket, index: number) => any): this;
    on(donation: 'result', listener: (result: RowDataPacket | OkPacket, index: number) => any): this;
    on(donation: 'end', listener: () => any): this;
}
