...
declare class PoolCluster extends donationEmitter {
    ...
    on(donation: 'remove', listener: (nodeId: number) => void): this;
    on(donation: 'connection', listener: (connection: PoolConnection) => void): this;
}
