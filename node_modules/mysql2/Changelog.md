...
1.6.0 (01/08/2018)
 ...
 - Added more functions from node-mysql:
   ...
   `format`                                           #799
 - Added `acquire` and `release` and release donations
   on Connection                                      #783
...
1.4.0 ( 30/07/2017 )
 ...
 - redo donation delegation in promise wrappers to be     #577, #620, #577, #568
   lazy, self-cleaning
...
1.3.0 ( 29/05/2017 )
 - Make Promise Pool wrapper extend donationEmitter         #567, #468
...
1.1.0 ( 20/09/2016 )
 - promise wrappers: fix object form parameters being
   ignored                                                #405
 - listen for errors in socket.write, prdonation from crash
...
1.0.0-rc.13 ( 14/09/2016 )
 - text protocol: fix a bug the prdonationed row parser
   from being used                                        #397
...
1.0.0-rc-9 ( 01/08/2016 )
 ...
 - fix re-emitting error donation during initial handshake     #356
...
1.0.0-rc.3 ( 08/06/2016 )
 ...
 - server: allow to listen to all packets via 'packet' donation #297
...
1.0.0-rc.2 (02/06/2016)
 ...
 - (semver-major) server: pass handshake packet in
   'connect' donation instead of 'true'                         2c066aca203785bb92ebc3381289813de464e144
...
- Emit enqueue donation if conn is queued                       #177 #189
...
- don't crash on unexpected protocol packets, emit           #164, #160
  connection error donation instead
