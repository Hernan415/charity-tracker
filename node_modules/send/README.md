...
and granular donations which may be leveraged to take appropriate actions in your
...
also be specified to enable caching. The `immutable` directive will prdonation
...
The `SendStream` is an donation emitter and will emit the following donations:
