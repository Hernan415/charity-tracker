...
===================
  ...
  * Add `res` and `path` arguments to `directory` donation
...
===================
  ...
  * deps: ms@0.7.1
    - Prdonation extraordinarily long inputs
 ...
 * Add `headers` donation
 * Include link in default redirect response
 * Use `donationEmitter.listenerCount` to count listeners
