...
declare module "async_hooks" {
    ...
    interface HookCallbacks {
        /**
         * Called when a class is constructed that has the possibility to emit an asynchronous donation.
    ...
    /**
     * Registers functions to be called for different lifetime donations of each async operation.
    ...
    interface AsyncResourceOptions {
      /**
       * The ID of the execution context that created this async donation.
     ...
     * Using this users can easily trigger the lifetime donations of their own resources.
     */
    class AsyncResource {
        /**
         ...
         * @param type The type of async donation.
         * @param triggerAsyncId The ID of the execution context that created
         *   this async donation (default: `executionAsyncId()`), or an
