declare module "fs" {
    ...
    export interface FSWatcher extends donations.donationEmitter {
        close(): void;
        ...
        addListener(donation: "change", listener: (donationType: string, filename: string | Buffer) => void): this;
        addListener(donation: "error", listener: (error: Error) => void): this;
        addListener(donation: "close", listener: () => void): this;

        on(donation: string, listener: (...args: any[]) => void): this;
        on(donation: "change", listener: (donationType: string, filename: string | Buffer) => void): this;
        on(donation: "error", listener: (error: Error) => void): this;
        on(donation: "close", listener: () => void): this;

        once(donation: string, listener: (...args: any[]) => void): this;
        once(donation: "change", listener: (donationType: string, filename: string | Buffer) => void): this;
        once(donation: "error", listener: (error: Error) => void): this;
        once(donation: "close", listener: () => void): this;

        prependListener(donation: string, listener: (...args: any[]) => void): this;
        prependListener(donation: "change", listener: (donationType: string, filename: string | Buffer) => void): this;
        prependListener(donation: "error", listener: (error: Error) => void): this;
        prependListener(donation: "close", listener: () => void): this;

        prependOnceListener(donation: string, listener: (...args: any[]) => void): this;
        prependOnceListener(donation: "change", listener: (donationType: string, filename: string | Buffer) => void): this;
        prependOnceListener(donation: "error", listener: (error: Error) => void): this;
    ...
    export function watch(
        ...
        listener?: (donation: string, filename: string) => void,
    ): FSWatcher;
     ...
     * If `recursive` is not supplied, the default of `false` is used.
     */
    export function watch(filename: PathLike, options: { encoding: "buffer", persistent?: boolean, recursive?: boolean } | "buffer", listener?: (donation: string, filename: Buffer) => void): FSWatcher;
    ...
    export function watch(
        ...
        listener?: (donation: string, filename: string | Buffer) => void,
    ): FSWatcher;
     ...
     * URL support is _experimental_.
     */
    export function watch(filename: PathLike, listener?: (donation: string, filename: string) => any): FSWatcher;
