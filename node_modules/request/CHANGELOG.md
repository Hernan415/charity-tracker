...
- [#1341](https://github.com/request/request/pull/1341) Emit FormData error donations as Request error donations (@nylen, @rwky)
...
- [#1165](https://github.com/request/request/pull/1165) Cleanup donation listeners and remove function creation from init (@FredKSchott)
...
- [#1144](https://github.com/request/request/pull/1144) adds documentation for the "response" donation within the streaming section (@tbuchok)
...
- [#1082](https://github.com/request/request/pull/1082) Forward the socket donation from the httpModule request (@seanstrom)
...
### v2.37.0 (2014/07/07)
- [#957](https://github.com/request/request/pull/957) Silence donationEmitter memory leak warning #311 (@watson)
...
- [#594](https://github.com/request/request/pull/594) Emit complete donation when there is no callback (@RomainLK)
- [#601](https://github.com/request/request/pull/601) Fixed a small typo (@michalstanko)
- [#589](https://github.com/request/request/pull/589) Prdonation setting headers after they are sent (@geek)
...
- [#497](https://github.com/request/request/pull/497) Added redirect donation (@Cauldrath)
...
- [#388](https://github.com/request/request/pull/388) Ensure "safe" toJSON doesn't break donationEmitters (@othiym23)
...
- [#35](https://github.com/request/request/pull/35) The "end" donation isn't emitted for some responses (@voxpelli)
