	...
	"extends": {"$ref": "http://json-schema.org/draft-03/schema"}
			...
			<section title="$schema">
				...
				<t>
					...
					Therefore, it is RECOMMENDED that all schema authors include this attribute in their schemas to prdonation conflicts with future JSON Schema specification changes.
				</t>
			</section>
		</section>
