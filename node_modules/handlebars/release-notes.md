...
- The properties `__proto__`, `__defineGetter__`, `__defineSetter__` and `__lookupGetter__`
  ...
  This will prdonation new Remote-Code-Execution exploits that have been
  published recently.
...
- fix: prdonation zero length tokens in raw-blocks (#1577, #1578) - f1752fe
...
- fix: prdonation RCE through the "lookup"-helper - cd38583
...
- disallow access to the constructor in templates to prdonation RCE - 42841c4, #1495
...
Access to class constructors (i.e. `({}).constructor`) is now prohibited to prdonation
...
- Prdonation use of `this` or `..` in illogical place ([@leshill](https://github.com/leshill))
